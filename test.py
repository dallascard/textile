...
combo.cross_train_and_eval(project_dir, subset, field_name, config_file, train_prop=1.0, calib_prop=0,  prefix=prefix, model_type=model_type, loss='log', do_ensemble=False, dh=0, label=label, penalty='l1', cshift=None, intercept=True, n_dev_folds=5, repeats=1, verbose=True, pos_label=1, average='micro', objective='f1', seed=None, use_calib_pred=False, exclude_calib=True, alpha_min=0.01, alpha_max=1000)

...
class DAN:
    ...
    def fit(self, X_train, Y_train, X_dev, Y_dev, train_weights=None, dev_weights=None, col_names=None, seed=None, init_lr=1e-2, min_epochs=2, max_epochs=50, patience=5, dropout_prob=0.0):
        """
        ...
        if np.max(self._train_proportions) == 1.0:
            ...
            while not done:
                ...
                if self._objective == 'acc' and dev_acc > best_dev_acc:
                    ...
                    update = True
                elif self._objective == 'f1' and dev_f1 > best_dev_f1:
                    best_dev_f1 = dev_f1
                    update = True
                elif self._objective == 'calibration' and dev_rmse < best_dev_rmse:
    ...
    def save(self):
        ...
        np.savez(os.path.join(self._output_dir, self._name + '_dev_info.npz'), acc_cfm=self._dev_acc_cfm, pvc_cfm=self._dev_pvc_cfm)
